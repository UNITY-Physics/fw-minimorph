...
def get_demo():
    ...
    vols2 = pd.read_csv(volume_seg2, delimiter='\t', header=None)
    extraAxial = vols2.iloc[0, 0].split()[0]

    vols3 = pd.read_csv(volume_seg3, delimiter='\t', header=None)
    tissue = vols3.iloc[0, 0].split()[0]
